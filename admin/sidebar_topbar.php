        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseBrand" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#">Thêm thương hiệu</a>
                        <a class="collapse-item" href="#">Danh sách thương hiệu</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseType" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#">Thêm loại sản phẩm</a>
                        <a class="collapse-item" href="#">Danh sách loại sản phẩm</a>
                    </div>
                </div>
            </li>
            <!-- Sản phẩm -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseSlider" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#">Thêm slider</a>
                        <a class="collapse-item" href="#">Danh sách slider</a>
                    </div>
                </div>
            </li>
            <!-- Review sản phẩm -->
