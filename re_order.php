...
<div class="container mb-3">
    <div class="mb-2">
        ...
        <i class='fas fa-chevron-right text-secondary' style="font-size: 12px;"></i>
        <span class="text-dark">Mua lại</span>
    </div>
    <div class="row">
                            ...
                            <div class="border-bottom border-2 p-0 mb-2 row g-0 py-2">
                                ...
                                <div class="card my-2 py-2">
                                    ...
                                    <div class="<?php if(isset($reOrder)) echo "d-none" ?>">
                                        <h4 class="text-center text-primary">Xác nhận mua lại</h4>
                                        <form action="" method="POST">
                                            <input type="text" class="my-3 form-control w-50 p-2 shadow-sm mx-auto" name="customerNote" placeholder="Ghi chú cho người bán...">
                                            <div class="d-flex justify-content-center mt-3 mb-2">
                                                <a onClick='window.history.back()' class="shadow btn btn-secondary mx-2 btn-cancel-order">Không</a>
                                                
                                                <button type="submit" name="re-order" class="shadow btn btn-primary mx-2 btn-cancel-order">Mua</button>
                                            </div>
                                        </form>
                                    </div>
                                ...
                                <div class="card card-timeline px-2 border-none my-2">
                                    ...
                                    if(!isset($reOrder)){
                                        ...
                                        echo '<div class="alert alert-success mx-5 text-center alert-dismissible fade show " role="alert">
                                            Cảm ơn bạn đã mua lại hàng! Chúng tôi sẽ sớm xác nhận đơn hàng.
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                        </div>';
                                    }
                                    ?>
