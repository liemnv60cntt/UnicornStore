                        ...
                        <div class="row border-start border-primary border-3 bg-white shadow rounded mx-0 px-3 pt-1 pb-2">
                            <div class="border-bottom border-2 p-0 mb-2 row g-0 py-2">
                                ...
                                <div class="card card-timeline px-2 border-none my-2">
                                    <?php 
                                        $get_order_status = $odr->get_order_by_id($orderID);
                                        if($get_order_status)
                                            $result_status = $get_order_status->fetch_assoc();
                                    ?>
                                    <ul class="bs5-order-tracking <?php if($result_status['orderStatus']==4) echo "d-none"; ?>">
                                    ...
                                    <ul class="bs5-order-tracking-2 <?php if($result_status['orderStatus']!=4) echo "d-none"; ?>">
                                        <li class="step active">
                                            <div><i class="fas fa-check-circle"></i></div> Đơn hàng đã đặt
                                        </li>
                                    ...
                                    <div class="alert alert-success mx-5 text-center alert-dismissible fade show <?php if($result_status['adminNote']=="") echo "d-none"; ?>" role="alert">
                                        <?php
                                        echo $result_status['adminNote']
                                        ?>
